...
Playbooks use Markdown with YAML front matter. The front matter defines the workflow name, summary, default provider, parameter contract, validation steps, optional instructions, and optional Linear issue lookup parameter. See [`workflows/README.md`](workflows/README.md) for the shipped format and `.metastack/workflows/README.md` for the repo-local scaffold.
...
- the built-in workflow contract shipped in `prompts/injected-agent-workflow-contract.md`
