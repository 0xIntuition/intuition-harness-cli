...
- [x] Changed `build.rs`
- [x] Changed `tests/commands.rs`
- [x] Changed `.intuition/backlog/ENG-10507/validation.md`
- [x] Recorded validation evidence in `.intuition/backlog/ENG-10507/validation.md`

### Remaining

- [x] Follow-up action 1
