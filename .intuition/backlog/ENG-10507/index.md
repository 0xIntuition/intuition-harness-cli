...
- [x] Changed `M tests/support/common.rs`
- [x] Changed `src/build.rs`
- [x] Changed `src/listen/mod.rs`
- [x] Changed `tests/listen.rs`
- [x] Changed `tests/support/common.rs`
- [x] Changed `.intuition/backlog/ENG-10507/index.md`
- [x] Prevented template placeholders from surfacing as listener backlog remaining work.
...
- [x] `cargo test --lib listen:: -- --nocapture`
