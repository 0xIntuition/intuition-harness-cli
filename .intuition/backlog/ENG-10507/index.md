...
- [x] Hardened the relevant `listen` resume-path tests so they stub GitHub interactions consistently during validation.
...
- [x] `cargo test --test listen listen_worker_reuses_stored_provider_native_resume_handle -- --nocapture`
- [x] `cargo test --test listen listen_worker_reuses_stored_codex_resume_handle -- --nocapture`
