...
- [x] Finished the `agents build` execution loop in `src/build.rs`.
- [x] Added focused integration coverage in `tests/build.rs`.
- [x] Updated command help/docs in `tests/commands.rs`, `README.md`, and `WORKFLOW.md`.
- [x] Recorded local validation evidence in `.intuition/backlog/ENG-10506/validation.md`.

### Remaining

- [ ] Push branch updates for the completed implementation.
