...
const BUILTIN_WORKFLOWS: [(&str, &str); 4] = [
    (
        ...
        include_str!("../workflows/builtin/backlog-planning.md"),
    ),
    (
        "builtin/ticket-implementation.md",
        include_str!("../workflows/builtin/ticket-implementation.md"),
    ),
    (
        "builtin/pr-review.md",
        include_str!("../workflows/builtin/pr-review.md"),
    ),
    (
        "builtin/incident-triage.md",
        include_str!("../workflows/builtin/incident-triage.md"),
    ),
];
