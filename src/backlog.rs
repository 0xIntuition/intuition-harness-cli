...
const CANONICAL_TEMPLATE_FILES: &[(&str, &str)] = &[
    ...
    (
        ...
        include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/tmp/_TEMPLATE/specification.md"
        )),
    ),
    (
        "implementation.md",
        include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/tmp/_TEMPLATE/implementation.md"
        )),
    ),
    (
        "validation.md",
    ...
    (
        ...
        include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/tmp/_TEMPLATE/context/README.md"
        )),
    ),
    (
        ...
        include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/tmp/_TEMPLATE/context/context-note-template.md"
        )),
    ),
    (
        "tasks/README.md",
    ...
    (
        ...
        include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/tmp/_TEMPLATE/tasks/workstream-template.md"
        )),
    ),
    (
        "artifacts/README.md",
        include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/tmp/_TEMPLATE/artifacts/README.md"
        )),
    ),
    (
        ...
        include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/tmp/_TEMPLATE/artifacts/artifact-template.md"
        )),
    ),
];
