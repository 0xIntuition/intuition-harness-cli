...
impl SyncDashboardApp {
    ...
    fn status_text(&self) -> String {
        ...
        match self.focus {
            ...
            Focus::Issues => {
                "Step 1 of 3: choose a backlog entry sourced from local `.metastack/backlog/`."
                    .to_string()
            }
...
mod tests {
    ...
    fn sync_dashboard_preview_scrolls_to_bottom() {
        ...
        let mut app = SyncDashboardApp::new(data, false);
        let _ = app.apply_in_viewport(SyncDashboardAction::Enter, viewport);
    ...
    fn render_once_mentions_mouse_wheel_in_preview_guidance() {
        let exit = run_sync_dashboard(
            ...
            SyncDashboardOptions {
                ...
                width: 120,
                height: 32,
                actions: vec![SyncDashboardAction::Enter, SyncDashboardAction::Enter],
                vim_mode: false,
            },
        )
        .expect("render once should succeed");
